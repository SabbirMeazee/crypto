...
const CoinDetails = () => {
    ...
    return (
        <>
            {
                loading ? (<Spinner></Spinner>) : (<div className='px-4 h-[80vh] mt-20 pb-24 mx-auto max-w-7xl md:px-2'>
                    <div className='h-full grid grid-cols-1 md:grid-cols-2 justify-items-center gap-4 content-center'>
                        <div className=' order-2 md:order-1'>
                            ...
                            <hr />
                            <h1 className='text-3xl'>Scores:</h1><hr />
                            <h1>Community Scores:{coin.community_score}</h1>
                            <h1>Developer Scores: {coin.developer_score}</h1>
                            <h1>Origin: {coin.country_origin ? coin.country_origin : 'Not Available'}</h1>
                        </div>

                        <div className='flex order-1 md:order-2 justify-center items-center'>
                            <img src={coin.image?.large} alt="coinImg" srcset="" />
                        </div>
